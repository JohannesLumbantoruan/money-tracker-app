...
const Dashboard = {
    ...
    _populateTransactionsDataToCard(transactionsHistory = null) {
        ...
        if (!Array.isArray(transactionsHistory)) {
            throw new Error('Paramater transactionsHistory should be an array.');
        }
        ...
        document.querySelector('#transactions-card')
    ...
    _populateTransactonsRecordToTable(transactionsHistory = null) {
        if (!(typeof transactionsHistory === 'object')) {
            throw new Error(
    ...
    _initialListener() {
        const recordDetailModal = document.querySelector('#recordDetailModal');
        ...
        const deleteRecordBtns = document.querySelectorAll('#recordsTable tbody .btn.btn-danger');
